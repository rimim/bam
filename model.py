...
class Model(BaseModel):
    def __init__(
        ...
        self.load_dependent2: bool = load_dependent2
    ...
    def compute_frictions(
        ...
        if self.load_dependent:
            ...
            if self.load_dependent2:
                frictionloss += self.load_friction_base2.value * gearbox_torque**2
...
models = {
    ...
    "m5": lambda: Model(
        name="m5", load_dependent=True, load_dependent2=True, stribeck=True
    ),
}
